...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.CompanySizesTests
{
	[UseReporter(typeof(DiffReporter))]
	public class RawDataIngestionTests : IDisposable
	{
		private string sqlTableName = "raw.HOST_CIG_CompanySizes";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_companysizes\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawCompanySizesTransformation();
