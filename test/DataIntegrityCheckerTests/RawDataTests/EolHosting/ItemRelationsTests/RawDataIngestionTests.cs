...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.ItemRelationsTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_ItemRelations";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_itemrelations\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawItemRelationsTestsTransformation();
			foreach (var columnName in columnNames)
			{
				//if (columnName == "Quantity"|| columnName == "MaxQuantity") continue;
				var sqlColumnValues = "";
