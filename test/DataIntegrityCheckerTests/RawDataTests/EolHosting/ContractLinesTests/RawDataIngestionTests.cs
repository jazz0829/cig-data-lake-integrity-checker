...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.ContractLinesTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_ContractLines";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_contractlines\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawContractLinesTransformation();
