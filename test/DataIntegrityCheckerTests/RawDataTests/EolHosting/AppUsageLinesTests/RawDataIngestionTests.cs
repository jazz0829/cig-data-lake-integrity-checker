...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.AppUsageLinesTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_AppUsageLines";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_appusagelines\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawAppUsageLinesTransformation();
