...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.Opportunities_HostingTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_Opportunities";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_opportunities\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawOpportunitiesHostingTransformation();
