...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.ActivitySectorsTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_ActivitySectors";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_activitysectors\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawActivitySectorsTransformation();
