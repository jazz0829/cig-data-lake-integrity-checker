...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.BusinessTypesTests
{
	[UseReporter(typeof(DiffReporter))]
	public class RawDataIngestionTests : IDisposable
	{
		private string sqlTableName = "raw.HOST_CIG_BusinessTypes";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_businesstypes\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawBusinessTypesTransformation();
