...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.ItemsTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_Items";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_items\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawItemsTransformation();
			foreach (var columnName in columnNames)
			{
				// Picture is a byte array
				// Do not compare for now
