...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.LeadSourcesTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_LeadSources";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_leadsources\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawLeadSourcesTestsTransformation();
