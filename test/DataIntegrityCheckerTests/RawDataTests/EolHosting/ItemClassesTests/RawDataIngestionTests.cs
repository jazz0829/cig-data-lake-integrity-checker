...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.ItemClassesTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_ItemClasses";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_itemclasses\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawItemClassesTestsTransformation();
