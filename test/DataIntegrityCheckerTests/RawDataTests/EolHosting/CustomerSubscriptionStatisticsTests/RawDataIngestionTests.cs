...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.CustomerSubscriptionStatisticsTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_CustomerSubscriptionStatistics";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_customersubscriptionstatistics\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawCustomerSubscriptionStatisticsTestsTransformation();
