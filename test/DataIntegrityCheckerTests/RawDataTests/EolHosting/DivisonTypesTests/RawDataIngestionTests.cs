...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.DivisonTypesTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_DivisionTypes";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_divisiontypes\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawDivisionTypesTestsTransformation();
