...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.OpportunitiesStagesTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_OpportunityStages";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_opportunitystages\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawOpportunityStagesTestsTransformation();
