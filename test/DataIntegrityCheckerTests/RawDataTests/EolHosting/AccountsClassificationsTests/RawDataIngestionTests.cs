...
namespace DataIntegrityCheckerTests.RawDataTests.EolHosting.AccountsClassificationsTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_classifications";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_classifications\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawAccountsClassificationsTransformation();
