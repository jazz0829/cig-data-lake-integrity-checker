...
namespace DataIntegrityCheckerTests.RawDataTests.CorparateBI.ContractsTests
{
	...
	{
		private string sqlTableName = "raw.HOST_CIG_Contracts";
		private string athenaTableName = "\"customerintelligence_raw\".\"object_host_cig_contracts\"";
		...
		public void data_in_source_and_athena_tables_match()
		{
			...
			var transformation = new RawContactsTestsTransformation();
